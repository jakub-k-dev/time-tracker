...
const navigation: FooterNavigation[] = [
  {
    name: "Facebook",
    href: "http://www.notafacebook.com",
    icon: (props) => (
  ...
  {
    name: "Instagram",
    href: "http://www.notainstagram.com",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "GitHub",
    href: "https://github.com/jakub-k-dev/time-tracker",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 flex flex-col md:flex-row md:items-center md:justify-between lg:px-8 gap-8 ">
        ...
        <div className="md:order-1">
          <p className="text-center text-xs leading-5 text-gray-500">
            &copy; 2023 JFK, Ing. No rights reserved.
          </p>
        </div>
      </div>
    </footer>
